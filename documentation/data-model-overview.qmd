...
The MediaWiki template files have been successfully documented and integrated into the project. See the [Templates documentation](../templates/index.qmd) for comprehensive details on all data entry forms, display templates, and category pages.
...
-   [Templates README](../templates/index.qmd)
